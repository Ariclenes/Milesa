 ...
 * @author Thomas Bolz
 */
public class NumeroTextField extends TextField {

    private final NumberFormat nf;

    private ObjectProperty<BigDecimal> numero = new SimpleObjectProperty<>();
    ...
    public NumeroTextField() {
        this(BigDecimal.ZERO);
    }

    public NumeroTextField(BigDecimal value) {
        this(value, NumberFormat.getInstance());
        initHandlers();
    }

    public NumeroTextField(BigDecimal value, NumberFormat nf) {
        super();
        this.nf = nf;
        initHandlers();
        setNumber(value);
