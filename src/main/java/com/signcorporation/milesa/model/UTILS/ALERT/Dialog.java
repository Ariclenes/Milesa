 ...
 */
package com.signcorporation.milesa.model.UTILS.ALERT;
...
/**
 * @author AEM Sign | arymonster@gmail.com
    ...
    private static VBox createHeader(Type type) {
        ...
        switch (type) {
            case INFO:
                ...
                icon = new ImageView(new Image("/VIEW/IMG/info_48dp.png"));
                break;
            case WARNING:
                color = Color.web("#FC6E51");
                icon = new ImageView(new Image("/VIEW/IMG/warning_48dp.png"));
                break;
            case ERROR:
                color = Color.web("#ED5565");
                icon = new ImageView(new Image("/VIEW/IMG/error_48dp.png"));
                break;
            case SUCCESS:
                color = Color.web("#02C852");
                icon = new ImageView(new Image("/VIEW/IMG/done_48dp.png"));
                break;
        }
...
//                break;
    ...
    private static void show(Region region) {
        ...
        dialog.setDialogContainer(SMART_ERP_CORP.SMART_ERP_CORP_BY_AEM_SIGN.getDecorator().getBackground());
