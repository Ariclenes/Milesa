...
public class Validacao {
    ...
    public static String BI = "[0-9]{3}\\.[0-9]{3}\\.[0-9]{3}\\-[0-9]{2}";
    public static String NIF = "[0-9]{2}\\.[0-9]{3}\\.[0-9]{3}/[0-9]{4}-[0-9]{2}";
    public static String INTEIRO = "[0-9]{1,9}";
    public static String MONEY = "[AKZ][$](([1-9]+\\.?\\d*)|([0]\\,\\d*)|[0])";
    public static String DOUBLE = "[0-9]{1,6}(|((\\.|)([0-9]{1,2})))";
    public static String SIGLA = ".{1,2}";
