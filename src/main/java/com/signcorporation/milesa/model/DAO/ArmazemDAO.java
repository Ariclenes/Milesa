...
public class ArmazemDAO implements CRUD<Armazem> {
    ...
    @Override
    public void guardar(Armazem t) throws ExceptionValidacao, SQLException {
        if (!existe(t)) {
            inserir(t);
        }
    }
    ...
    @Override
    public boolean existe(Armazem t) throws ExceptionValidacao, SQLException {
    ...
    @Override
    public void inserir(Armazem t) throws ExceptionValidacao, SQLException {
        ConexaoBD con = new ConexaoBD();
        Connection conexao;
    ...
    @Override
    public void alterar(Armazem t) throws ExceptionValidacao, SQLException {
        ConexaoBD con = new ConexaoBD();
...
//                                    
    ...
    @Override
    public ObservableList<Armazem> listar(boolean somenteAtivos) throws ExceptionValidacao, Exception {
