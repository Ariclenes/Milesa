...
import MODELO.BEAN.Item_pedido;
import MODELO.BEAN.Pedido_venda;
...
//									null,
//								new Produtos().pesquisar(rs2.getInt("id_produto_fk")).size() != 0 ?
