...
public class Produto {
    ...
    private StringProperty NOME_ARTIGO, CODBARRA, FOTO_ARTIGO, ESTOQUE_MINIMO, ESTOQUE_MAXIMO, ESTOQUE_ATUAL;
    ...
    public void setESTOQUE_ATUAL(String ESTOQUE_ATUAL) {
        this.ESTOQUE_ATUAL = new SimpleStringProperty(ESTOQUE_ATUAL);
    }
